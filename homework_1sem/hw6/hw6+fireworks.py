...
class Fireworks:
    ...
    def __init__(self, coords=[50, 50], radius=15, first_speed=20, color=(255, 255, 255), fi=0):
        self.coords = coords
    ...
    def move(self):
        self.coord[0] += self.speed * cos(fi)
        self.coord[1] += self.speed * sin(fi)

    def dying(self):
        while self.timelife == 40:
